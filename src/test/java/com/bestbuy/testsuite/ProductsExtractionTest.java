...
// 1.5V CopperTop Batteries (4-Pack)
    ...
    @Test
    public void test017() {
        List<Integer> listOfManufacturer = response.extract().path("data.manufacturer");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("List of Ids are : " + listOfManufacturer);
    ...
    public void test020() {
        ...
        System.out.println("the createdAt for all products whose price > 5.99 are: " + url);
    }
}